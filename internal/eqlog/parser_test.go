...
func TestParseRowClassifiesSharedEventPatterns(t *testing.T) {
	tests := []struct {
		...
		{"melee miss", "You try to crush Gorgalosk, but miss!", data.LogRowEventTypeFailedMelee},
		{"melee dodge", "You try to shoot Gorgalosk, but Gorgalosk dodges!", data.LogRowEventTypeFailedMelee},
		{"melee parry", "You try to slash Gorgalosk, but Gorgalosk parries!", data.LogRowEventTypeFailedMelee},
		{"melee block", "You try to kick Gorgalosk, but Gorgalosk blocks!", data.LogRowEventTypeFailedMelee},
		{"melee magical absorb", "You try to bash Gorgalosk, but Gorgalosk's magical skin absorbs the blow!", data.LogRowEventTypeFailedMelee},
		{"melee miss annotation", "You try to crush Gorgalosk, but miss! (Riposte)", data.LogRowEventTypeFailedMelee},
		...
		{"bonus experience", "You gain experience (with a bonus)! (3.559%)", data.LogRowEventTypeExperience},
		{"bonus party experience", "You gain party experience (with a bonus)! (0.283%)", data.LogRowEventTypeExperience},
		{"kill experience", "You gain party experience!", data.LogRowEventTypeKillExperienceReward},
		{"bonus kill experience", "You gain experience (with a bonus)!", data.LogRowEventTypeKillExperienceReward},
