								...
								return layout.Inset{Top: unit.Dp(4)}.Layout(gtx, func(gtx layout.Context) layout.Dimensions {
									...
									return layout.Flex{Axis: layout.Horizontal}.Layout(gtx,
										layout.Rigid(func(gtx layout.Context) layout.Dimensions {
											return layout.Inset{Top: unit.Dp(4), Right: unit.Dp(16)}.Layout(gtx, material.Label(style.Theme, ui.Sp(15), fmt.Sprintf("Line %d:", r)).Layout)
										}),
...
func (m *Module) RenderList(style *ui.Style, gtx layout.Context) layout.Dimensions {
	return layout.UniformInset(unit.Dp(16)).Layout(gtx, func(gtx layout.Context) layout.Dimensions {
		...
		return layout.Flex{Axis: layout.Vertical}.Layout(gtx,
			layout.Rigid(material.Label(style.Theme, ui.Sp(17), "Macros").Layout),
			layout.Rigid(func(gtx layout.Context) layout.Dimensions {
